...
const sections = [
    ...
    content: (
      <>
        <p className="text-sm text-gray-600 leading-relaxed">
          At LuxWatch, customer satisfaction is our top priority. If you are not
          completely satisfied with your purchase, you may request a refund or
          exchange under the conditions outlined below.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-sm text-gray-600 leading-relaxed">
          To be eligible for a refund, your item must be unused, in the same
          condition that you received it, and in its original packaging. Refund
    ...
    content: (
      <>
        <p className="text-sm text-gray-600 leading-relaxed">
          ...
          support@luxwatch.com with your order details. Once your return is
          received and inspected, we will notify you of the approval or
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm text-gray-600 leading-relaxed">
          Certain items are non-refundable, including gift cards, custom orders,
          and items marked as final sale. Watches showing signs of wear or
          damage not due to our error are not eligible for refund.
        </p>
      </>
    ),
  },
