...
export const BlogPost = [
  {
    ...
    description: 'Common Sense Machines uses Meta Segment Anything Model 2 to analyze 2D images and video and translate their components to 3D.',
    date: 'May 1, 2025',
  },
  {
    image: '/images/watch.jpg',
  ...
  return (
    <div className="flex flex-col md:flex-row bg-[#f4f7fa] rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
      ...
      <div className="md:w-1/2 p-6 flex flex-col justify-center gap-2">
        ...
        <h2 className="text-xl font-semibold text-gray-800 hover:underline cursor-pointer">{title}</h2>
