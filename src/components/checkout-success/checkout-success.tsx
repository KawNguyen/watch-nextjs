...
import { CheckCircle, Package, Truck, Shield, Star, Download, Mail, Phone } from "lucide-react"
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    ...
                                    <p className="text-sm text-blue-700 mt-1">
                                        Your tracking number will be sent to your email within 24 hours
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                {"We're preparing your watch for shipment"} (1-2 business days)
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">Your watch will arrive in 2-3 business days</p>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="bg-green-50 p-3 rounded-lg">
                                    ...
                                    <p className="text-xs text-green-700">Charged to card ending in 3456</p>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    {"We've sent a detailed confirmation email to "} <strong>john@example.com</strong> {" with your order details and tracking information."}
                                </p>
                            </div>
                        </div>
                    </CardContent>
